...
export const About: any = () => {
  return (
    <div className="lg:h-[80vh] lg:w-full lg:flex  lg:pl-[3vh] mt-5">
          <div className=" flex-col sm:justify-center sm:items-center lg:h-[80vh] sm:h-[55vh] lg:w-[70%]">
          ...
          <div className=" sm:h-[40vh] flex justify-start lg:items-center lg:h-[80vh] lg:w-[30%] sm:ml-[2vh] ">
