  ...
  return (
    ...
    className="lg:flex lg:w-full lg:justify-center sm:w-full sm:flex sm:justify-center">
          ...
          {/* all svgs */}
            ...
            <svg
            className="mt-[6px] sm:pb-[2px] cursor-pointer"
            ...
            <div className="  lg:relative lg:group lg:flex lg:justify-center sm:w-full sm:flex sm:justify-center lg:w-[30vw] ">
              <span className="cursor-pointer sm:tracking-normal mt-2 tracking-wider flex  text-[#2C2C2C] lg:text-5xl sm:text-3xl sm:pl-[0vh] font-bold">
                CONNECT WITH ME
              </span>
        ...
        <div className="text-right  sm:pt-[40vh] lg:pt-[20vh] lg:pr-[2vw]">
          ...
          <a
            ...
            target="_blank"
            className="lg:pr-[13vh] sm:pr-[16vh] relative lg:text-4xl sm:text-2xl mt-4 block font-semibold lg:tracking-wide sm:tracking-normal"
