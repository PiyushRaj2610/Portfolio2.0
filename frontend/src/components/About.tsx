  ...
  return (
    <div className="lg:h-[80vh] lg:w-full lg:flex  lg:pl-[3vh] mt-5">
          ...
          <div className=" sm:h-[50vh] flex justify-start lg:items-center lg:h-[80vh] lg:w-[30%] sm:ml-[2vh] ">
            <div className="lg:h-[35vh] lg:w-[35vh] sm:w-[20vh] rounded-4xl lg:border-5 border-white sm:h-[20vh] sm:border-4 bg-gradient-to-b from-[#55C0BB] to-[#DD8080] cursor-pointer z-[999999]">
              <img 
              src={pfp}
