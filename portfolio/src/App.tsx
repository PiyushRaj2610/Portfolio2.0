      ...
      {/* <img src={} className="absolute top-0 left-0 w-[100vw] h-[100vh] object-cover opacity-30" alt="" /> */}
        ...
        <div className="flex justify-center pt-10">
          <div className="border-[#C6CBA9] border-b-[1px] pb-1 rounded-full flex justify-center">
            <div className="bg-[#282828] pt-1 h-[7vh] w-[60vh] rounded-full flex text-white justify-between items-center pl-[2vh] pr-[2vh]">
        ...
        <div className="flex w-full justify-center">
          <div className="inline-block text-[#C6CBA9] pl-[3vw] pt-[20vh] flex-1 items-center justify-center text-9xl font-semibold tracking-widest">
          
          <div className="inline-block text-[#C6CBA9] pl-[8vh] flex-1 text-9xl font-semibold tracking-wider">
            <Typewriter 
            words={["FULLSTACK"]} 
            loop={1} 
            cursor 
            ...
            <div className="mt-4 h-[6vh] pl-[9vh] w-[16vw] pr-[3vh] flex justify-between">
            <a href="https://github.com/PiyushRaj2610" target="_blank">
            <svg
            className="h-11 w-[41px] cursor-pointer"
            ...
            <div className="relative group w-[30vw] ">
              
              <span className="cursor-pointer mt-2 pl-[8vh] tracking-wider flex  text-[#2C2C2C] text-5xl font-bold">
                CONNECT WITH ME
              </span>
          ...
          <div
          ref={borderRef}
          className=" absolute  w-[60vw] flex justify-center left-1/2 top-[28vh] pt-[30vh] -translate-x-1/2 -translate-y-1/2 cursor-pointer  overflow-hidden"
          >
          ...
          <div className="text-right pt-[20vh] pr-[2vw]">
          <h1 className="text-[#C6CBA9] text-9xl ml-[4vh] font-semibold tracking-wider pr-[12vh]">
            <Typewriter words={["DEVELOPER"]} loop={1} cursor cursorStyle="" typeSpeed={80} />
          </h1>
          <a
            href="https://www.google.com"
            target="_blank"
            className="pr-[13vh] relative text-4xl mt-4 block font-semibold tracking-wide"
            style={{ position: "absolute", bottom: "48vh", right: "2rem" }}
          >
            <span className="text-[#55C0BB]">Click to view my</span> <span className="text-[#DD8080]">RESUME</span>
          </a>
        </div>
        ...
        <div className=" h-[100vh] mt-8">
          <div className="h-[30vh] w-full text-white flex items-end pl-[4vh] pb-[1vh]">
            <div className="w-970vh] text-6xl font-semibold align-text-bottom tracking-wide flex items-end border-b-4 border-[#55C0BB]">
              Tech Stacks & Expertise
            </div>
          </div>
          <div className="relative flex justify-center items-center">
          <div className="absolute top-[5vh] h-[30vh] w-full flex justify-center z-10">
            <AnimatedBoxes />
          </div>

          <div className="text-[#2C2C2C] text-[28vh] tracking-widest flex mt-[3vh] font-bold z-0">
            S K I L L S
          </div>
        </div>
