...
import resume from "../assets/PiyushResume.pdf (1).pdf"
  ...
  return (
    ...
    className="lg:flex lg:w-full lg:justify-center sm:w-full sm:flex sm:justify-center">
          ...
          {/* all svgs */}
            ...
            <div className="lg:mt-4 lg:h-[6vh] lg:pl-[9vh] lg:w-[16vw] lg:pr-[3vh] lg:flex lg:justify-between sm:flex sm:justify-between sm:pl-[19vh] sm:pr-[12vh] sm:w-14vw] relative z-[9999]">
            <a href="https://github.com/PiyushRaj2610" target="_blank">
            <svg
            className="lg:h-11 sm:mb-2 w-[42px] z-[9999]"
            ...
            <svg
            className="mt-[6px]  sm:m-2 sm:pb-[2px]"
            ...
            <div className="relative pl-[8vh] group inline-block">
            {/* Main Text */}
            <span className="cursor-pointer text-[#2C2C2C] lg:text-5xl sm:text-xl font-bold">
              CONNECT WITH ME
            </span>

            {/* Tooltip Box (Appears Below on Hover) */}
            <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-max px-4 py-2 bg-white text-black font-bold rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-300 shadow-lg border border-gray-300">
              Hello
            </div>
          </div>
          ...
          <div
          ref={borderRef}
          className=" lg:absolute sm:absolute z-0 w-full flex justify-center left-1/2 top-[28vh] lg:pt-[30vh] sm:pt-[10vh] -translate-x-1/2 -translate-y-1/2 cursor-  overflow-  "
          >
        ...
        <div className="text-right  sm:pt-[40vh] lg:pt-[20vh] lg:pr-[2vw]">
          ...
          <a
            href={resume}
            target="_blank"
            className="lg:pr-[13vh] sm:mr-[vh] relative lg:text-4xl sm:text-[17px] mt-4 block font-semibold lg:tracking-wide sm:tracking-normal"
