  ...
  return (
    <div className=" lg:h-[100vh] sm:h-[80vh] mt-8">
          ...
          <div className="relative flex justify-center items-center  h-[80vh]  pr-[5vh] p-[4vh] w-full ">
            <div className="bg-[#141414] rounded-4xl border-b-2  border-t-2 border-[#55C0BB] h-full lg:w-[90vw] sm:w-[80vw] flex justify-center items-center ">
              <div className="absolute lg:h-[30vh] pb-[12vh] flex justify-center items-center z-10">
              <AnimatedBoxes />
              </div>

              <div className="text-[#1d1d1d] lg:text-[28vh] sm:text-[10vh] lg:tracking-widest flex lg:pb-[9vh] sm:tracking-tight font-bold z-0">
                S K I L L S
              </div>
            </div>
        </div>
